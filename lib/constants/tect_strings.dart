...
const String appName='DocForge';
const String appTagLine='Empowering Document Creation And Optimization';


const String welcomeTitle="DocForge";
const String welcomeSubTitle="Empowering Document Creation And Optimization";
